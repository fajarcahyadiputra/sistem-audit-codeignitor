...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-default pt-2">
            <div class="panel-heading no-collapse">Data Audit
            </div>
                ...
                <table id="datatablenya" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>Tanggal AKhir</th>
                            <th>Status</th>
                            <th>Bagian Di Audit</th>
                            <th class="not-export-col">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $i=1;foreach($audits as $data): ?>
                        <tr>
                            <td><?php echo $i++ ?></td>
                              ...
                              <?php if($data->status != 'close'): ?>
                                ...
                                <?php if($group == 'auditor'){ ?>
                                  ...
                                  <?php if($data->tahapan == 4){ ?>
                                     <a href="<?php echo base_url('audit/pesan_kesalahan/'. $data->id) ?>" class="badge btn-warning">Daftar tilik</a> 
                                     <a href="<?php echo base_url('audit/close/'. $data->id) ?>" class="badge btn-success">Close</a> 
                                    <?php  } else if($data->tahapan == 6 || $data->tahapan == 5) {?>
                                      <a href="<?php echo base_url('audit/close/'. $data->id) ?>" class="badge btn-success">Close</a> 
                                    <?php  }else{?>
                                      <a href="<?php echo base_url('audit/kisi_kisi/'. $data->id) ?>" class="badge btn-warning">Kisi-Kisi</a>
                                    <?php } ?>
                                     <!-- if role auditee -->
                                <?php }else if($group == 'auditee'){ ?>
                                   <!-- if tahapan ke 5 -->
                                    <?php if($data->tahapan == 5){ ?>
                                      <a href="<?php echo base_url('audit/balasan_kesalahan/'. $data->id) ?>" class="badge btn-warning">Balasan Kesalahan</a> 
                                    <?php }else{ ?>
                                      <a href="<?php echo base_url('audit/pilih_document/'. $data->id) ?>" class="badge btn-warning">Pilih Document</a> 
                                    <?php } ?>
                                <?php } ?>
                              <?php endif ?>
                              <?php if($group == 'qs' || $group == 'admin'){ ?>
                              <a href="<?php echo base_url('audit/delete/'. $data->id) ?>" class="badge btn-danger">Hapus</a>
                              <?php } ?>
                              <a href="<?php echo base_url('audit/detail/'. $data->id) ?>" class="badge btn-info">Detail</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
